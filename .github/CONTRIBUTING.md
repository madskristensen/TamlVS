...
>
> A summary of the issue and the VS/OS environment in which it occurs. If
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/TamlTokenizer.git
   # Navigate to the newly cloned directory
   cd TamlTokenizer
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/madskristensen/TamlTokenizer.git
   ```
...
4. Commit your changes in logical chunks. Please adhere to these [git commit
   ...
   to the commit message. For instance: "TAML: Fixes tokenizer for edge case.\nFixes `#123`"
