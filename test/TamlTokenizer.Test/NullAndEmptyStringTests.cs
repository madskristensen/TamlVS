...
public sealed class NullAndEmptyStringTests
{
    ...
    public void WhenNullAndEmptyStringThenDistinguished()
    {
        ...
        TamlToken? nullToken = result.Tokens.FirstOrDefault(t => t.Type == TamlTokenType.Null);
        TamlToken? emptyToken = result.Tokens.FirstOrDefault(t => t.Type == TamlTokenType.EmptyString);
    ...
    public void WhenSingleQuoteThenNotEmptyString()
    {
        ...
        TamlToken? valueToken = result.Tokens.FirstOrDefault(t => t.Type == TamlTokenType.Value);
